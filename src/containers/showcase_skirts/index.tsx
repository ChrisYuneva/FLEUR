            ...
            <div className={style.div}>
                ...
                <div className={style.scan}>
                    ...
                    <span className={style.span}>
                        Прямой покрой, плиссе или клеш — пополните ваш гардероб
                        новыми моделями юбок. Независимо от того, что вы
                        предпочитаете — экстравагантный дизайн или классические
                        фасоны — в нашей коллекции юбок есть модели на любой
                        вкус.
                    </span>
