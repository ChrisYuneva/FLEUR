                ...
                <div className={style.div}>
                    ...
                    <div className={style.scan}>
                        ...
                        <span className={style.span}>
                            Прямой покрой, плиссе или клеш — пополните ваш
                            гардероб новыми моделями юбок. Независимо от того,
                            что вы предпочитаете — экстравагантный дизайн или
                            классические фасоны — в нашей коллекции юбок есть
                        ...
                        <div className={style.show}>
                            ...
                            <div className={style.showrow}>
                                ...
                                <Lot
                                    img={asset.skirts_11}
                                    name={
                                        'Юбка в складку из искусственной кожи'
                                    }
                                    price={'2 999 руб.'}
                                ></Lot>
                                <Lot
