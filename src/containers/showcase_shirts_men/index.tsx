            ...
            <div className={style.div}>
                ...
                <div className={style.scan}>
                    ...
                    <span className={style.span}>
                        Качественные рубашки отличного покроя в разнообразных
                        стилях. Элегантные и простые рубашки для рабочих будней,
                        а для создания непринужденного образа в выходные дни —
                        удобные повседневные модели.
                    </span>
