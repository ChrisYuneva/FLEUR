                ...
                <div className={style.div}>
                    ...
                    <div className={style.scan}>
                        ...
                        <span className={style.span}>
                            Составляйте стильные ансамбли с белоснежными
                            рубашками, прозрачными блузками и легкими туниками.
                            Чтобы создать всегда актуальный и безупречный образ,
                            который легко преобразить, сочетайте любимые изделия
                        ...
                        <div className={style.show}>
                            <div className={style.showrow}>
                                ...
                                <Lot
                                    img={asset.shirt_w_3}
                                    name={
                                        'Рубашка из струящейся ткани с карманами'
                                    }
                                    price={'3 299 руб.'}
                                ></Lot>
                                <Lot
