                ...
                <div className={style.div}>
                    ...
                    <div className={style.scan}>
                        ...
                        <span className={style.span}>
                            Стильная и удобная толстовка или худи — это
                            идеальное решение в те дни, когда вы не знаете, что
                            надеть. Наши модели всегда отличаются актуальными
                            принтами и фасонами, поэтому делают любой образ
                            стильным и непринужденным.
                        </span>
