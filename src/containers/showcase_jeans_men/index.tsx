                ...
                <div className={style.div}>
                    ...
                    <div className={style.scan}>
                        ...
                        <span className={style.span}>
                            ...
                            нашей обширной коллекции мужских джинсов вы
                            обязательно найдете модель, которая идеально
                        ...
                        <div className={style.show}>
                            ...
                            <div className={style.showrow}>
                                ...
                                <Lot
                                    img={asset.jeans_m_8}
                                    name={
                                        'Джинсы облегающего кроя в стиле 90-х'
                                    }
                                    price={'2 999 руб.'}
                                ></Lot>
                            </div>
                            <div className={style.showrow}>
                                ...
                                <Lot
                                    ...
                                    name={
                                        'Базовые джинсы с эффектом брызг краски'
                                    }
                                    price={'4 499 руб.'}
                                ></Lot>
                            </div>
