                ...
                <div className={style.div}>
                    ...
                    <div className={style.scan}>
                        ...
                        <span className={style.span}>
                            Джинсы — это один из базовых предметов гардероба. В нашей обширной коллекции мужских джинсов вы обязательно найдете модель, которая идеально подойдет для вашего стиля и типа фигуры. Наши джинсы представлены во всевозможных фасонах — от классических прямых, выдержанных в синих оттенках, до узких черных. На ваш выбор представлены модели светлых и темных расцветок, с рваными элементами или элегантной отделкой.
                        </span>
