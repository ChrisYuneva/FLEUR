                ...
                <div className={style.div}>
                    ...
                    <div className={style.scan}>
                        ...
                        <span className={style.span}>
                            Приобретайте мужские футболки и майки в
                            интернет-магазине H&M. Выбирая футболки с принтами
                            для вашего повседневного гардероба, отдайте
                            предпочтение актуальным моделям, которые помогут
                            выразить вашу индивидуальность. Или отдайте
                            предпочтение базовым моделям, познакомившись с нашим
                            ассортиментом классических мужских хлопковых
                            футболок и маек стандартного или облегающего кроя.
                            Идете в спортзал? Ознакомьтесь с нашим ассортиментом
                            спортивных футболок, маек и лонгсливов, которые
                            идеально подойдут для ваших тренировок в любое время
                            года.
                        </span>
